<template>
  <div>
    <div style="margin-bottom: 5px">
      <el-input v-model="name" placeholder="仓库名" suffix-icon="el-icon-search" style = "width:200px"
    ...
    >
      ...
      <el-table-column prop="name" label="仓库名" width="250" align="center">
      </el-table-column>
      <el-table-column prop="remark" label="备注" align="center">
      </el-table-column>
      <el-table-column prop="opetare" label="操作" width="400" align="center">
